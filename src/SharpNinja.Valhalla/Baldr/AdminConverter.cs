// Faithful C# port of the free function get_iso_3166_1_alpha3 from
// valhalla/src/baldr/admin.cc @ 3.7.0. The full ISO 3166-1 alpha2 -> alpha3 map is
// reproduced verbatim (same key/value pairs, same order is irrelevant for a hash map).
...
/// <summary>
/// Hosts the free function <c>get_iso_3166_1_alpha3</c> and its lookup map.
/// </summary>
public static class AdminConverter
{
    // For transforming ISO 3166-1 country codes from alpha2 to alpha3.
    private static readonly Dictionary<string, string> Iso2ToIso3 = new()
    {
    ...
    /// <summary>
    /// Returns the 3-char equivalent of the 2-char country code (iso_3166_1_alpha2) or an empty
    /// string if the 2-char code is unknown.
    /// </summary>
    public static string GetIso31661Alpha3(string iso31661Alpha2)
        => Iso2ToIso3.TryGetValue(iso31661Alpha2, out var alpha3) ? alpha3 : string.Empty;
}
